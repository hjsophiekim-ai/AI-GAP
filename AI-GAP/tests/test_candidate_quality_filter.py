...
class TestOverheatPenalty:
    ...
    def test_3d_surge_penalty(self):
        ...
        qf = _default_filter()
        c = _make_candidate(current_price=13000.0, open_p=12800.0, high=13200.0, low=12700.0, previous_close=12700.0)
        # 3일 전 가격 10000 → +30%
        daily = [
    ...
    def test_5d_crash_risk_penalty(self):
        ...
        qf = _default_filter()
        c = _make_candidate(current_price=8000.0, open_p=7900.0, high=8100.0, low=7800.0, previous_close=7900.0)
        # 5일 전 10000 → -20%
        daily = [
